import { V as reactExports, u as functionalUpdate$1, a as arraysEqual, g as createLRUCache, G as isPromise, H as isRedirect, F as isNotFound, A as invariant, f as createControlledPromise, a1 as rootRouteId, I as isServer$1, d as compileDecodeCharMap, a3 as trimPath, a0 as rewriteBasepath, e as composeRewrites, U as processRouteTree, S as processRouteMasks, $ as resolvePath, c as cleanPath, a5 as trimPathRight, Q as parseHref, p as executeRewriteInput, B as isDangerousProtocol, W as redirect, t as findSingleMatch, k as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, z as interpolatePath, P as nullReplaceEqualDeep, Y as replaceEqualDeep$1, L as last, j as decodePath, r as findFlatMatch, s as findRouteMatch, y as hasKeys, q as executeRewriteOutput, m as encodePathLikeUrl, a4 as trimPathLeft, J as joinPaths, a7 as useRouter, l as dummyMatchContext, M as matchContext, Z as requireReactDom, o as exactPathTest, X as removeTrailingSlash, R as React, K as jsxRuntimeExports, E as isModuleNotFoundError, a6 as useHydrated, n as escapeHtml, C as isInlinableStylesheet, v as getAssetCrossOrigin, _ as resolveManifestAssetLink, O as Outlet, N as notFound } from "./server-Dg-eis91.js";
...
const appCss = "/assets/styles-cSbQG3iK.css";
...
const $$splitComponentImporter$2 = () => import("./results-DXAQ-Xpy.js");
  ...
  head: ({
    ...
    return {
      meta: [{
        ...
        name: "description",
        content: `Compare bus, train and car routes from ${from || "your start"} to ${to || "your destination"} in Bulgaria.`
      }, {
        property: "og:title",
        content: title
      }]
...
const $$splitComponentImporter$1 = () => import("./index-DqHy5p2z.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Compare routes across Bulgaria by bus, train or car."
    }]
  }),
...
const CITY_COORDS = {
  ...
  sozopol: { lat: 42.418, lng: 27.6953 },
  nesebar: { lat: 42.6593, lng: 27.733 },
...
const LANDMARKS = [
  {
    ...
    name: "Rila Monastery",
    city: "Rila Mountains",
    description: "UNESCO 10th-century monastery tucked in pine forests.",
    emoji: "⛪",
    lat: 42.134,
    lng: 23.3403,
    ...
    hours: "Daily 07:00–20:00 (church 06:00–22:00)",
    ticketPrice: "Courtyard free · Museum 8 BGN · Hrelyo's Tower 5 BGN",
    bestTime: "Early morning or late afternoon to avoid tour buses",
    website: "https://rilskimanastir.org",
    tips: ["Dress modestly — covered shoulders and knees", "Photography forbidden inside the main church", "Try the donut-like 'mekitsi' from the bakery outside the gate"]
  },
  {
    slug: "plovdiv-old-town",
    name: "Plovdiv Old Town",
    city: "Plovdiv",
    description: "Cobbled Revival quarter with Roman ruins underfoot.",
    emoji: "🏛️",
    lat: 42.15,
    lng: 24.751,
    ...
    hours: "Open 24/7 (Roman Theatre 09:00–18:00)",
    ticketPrice: "Old Town free · Roman Theatre 5 BGN · Ethnographic Museum 5 BGN",
    bestTime: "Spring & September — pleasant weather, fewer crowds",
    website: "https://visitplovdiv.com",
    tips: ["Wear flat shoes for the cobblestones", "Buy a combo ticket if visiting 3+ museums", "Stay for sunset over the Rhodopes from Nebet Tepe"]
  },
  {
    slug: "tsarevets-fortress",
    name: "Tsarevets Fortress",
    city: "Veliko Tarnovo",
    description: "Medieval citadel above the Yantra river bend.",
    emoji: "🏰",
    lat: 43.082,
    lng: 25.654,
    ...
    hours: "Apr–Oct 08:00–19:00 · Nov–Mar 09:00–17:00",
    ticketPrice: "Adults 10 BGN · Students 4 BGN",
    bestTime: "Summer evenings — catch the 'Sound and Light' show",
    website: "https://museumvt.com",
    tips: ["The Sound and Light show runs on special dates — check the schedule", "Climbing the tower is steep but worth it", "Combine with Samovodska Charshia craft street"]
  },
  {
    slug: "belogradchik-rocks",
    name: "Belogradchik Rocks",
    city: "Belogradchik",
    description: "Surreal red sandstone formations and a hilltop fort.",
    emoji: "🪨",
    lat: 43.6256,
    lng: 22.6831,
    ...
    hours: "Apr–Oct 08:00–20:00 · Nov–Mar 09:00–17:00",
    ticketPrice: "Fortress 6 BGN · Magura Cave (nearby) 6 BGN",
    bestTime: "Golden hour — the rocks glow red",
  ...
  },
  {
    ...
    description: "Dramatic red cliffs jutting into the Black Sea.",
    emoji: "🌊",
    lat: 43.3661,
    lng: 28.4661,
    ...
    hours: "Daily 08:00–20:00 (reserve gates close earlier off-season)",
    ticketPrice: "Reserve entry 3 BGN · Museum 3 BGN",
    bestTime: "May–September for dolphin sightings",
  ...
  {
    slug: "seven-rila-lakes",
    name: "Seven Rila Lakes",
    city: "Rila National Park",
    description: "Glacial lakes strung across an alpine cirque.",
    emoji: "🏞️",
    lat: 42.2164,
    lng: 23.3194,
    ...
    hours: "Chairlift Jun–Oct 08:30–17:00 (weather permitting)",
    ticketPrice: "Chairlift return 21 BGN · Park entry free",
    bestTime: "July–September — snow-free trails",
  ...
  {
    slug: "nesebar-old-town",
    name: "Nesebar Old Town",
    city: "Nesebar",
    description: "Island town packed with Byzantine churches.",
    emoji: "⛵",
    lat: 42.6593,
    lng: 27.733,
    ...
    hours: "Old Town open 24/7 · Most churches 09:30–18:00",
    ticketPrice: "Combined church ticket 10 BGN",
    bestTime: "Late spring or September — July & August get packed",
  ...
  },
  {
    ...
    city: "Central Stara Planina",
    description: "Otherworldly brutalist UFO on a mountain ridge.",
    emoji: "🛸",
    lat: 42.7358,
    lng: 25.3936,
    ...
    hours: "Exterior accessible year-round · Interior CLOSED to public",
    ticketPrice: "Free (exterior only)",
    bestTime: "Late spring through autumn — road closed by snow in winter",
    website: "https://buzludzha-monument.com",
    tips: ["Do not attempt to enter — it's unsafe and patrolled", "The last 12 km of road is steep — check your tyres", "Guided 'open days' run a few times a year — book ahead"]
  },
  {
    slug: "pirin-national-park",
    name: "Pirin National Park",
    city: "Bansko",
    description: "Granite peaks, glacial lakes, alpine trails.",
    emoji: "⛰️",
    lat: 41.76,
    lng: 23.43,
    ...
    hours: "Open year-round · Refuges Jun–Oct",
    ticketPrice: "Park entry free · Bansko gondola return 30 BGN",
    bestTime: "July–September for hiking · Dec–April for skiing",
  ...
  {
    slug: "sozopol-old-town",
    name: "Sozopol Old Town",
    city: "Sozopol",
    description: "Wooden houses on a pine-covered peninsula.",
    emoji: "🏖️",
    lat: 42.418,
    lng: 27.6953,
    ...
    hours: "Open 24/7 · Archaeological Museum 09:00–18:00",
    ticketPrice: "Town free · Archaeological Museum 5 BGN · St Ivan island boat ~20 BGN",
    bestTime: "June or September for warm sea without summer crowds",
  ...
  },
  {
    ...
    name: "Koprivshtitsa",
    city: "Sredna Gora",
    description: "Frozen-in-time Revival village of painted houses.",
    emoji: "🏘️",
    lat: 42.6356,
    lng: 24.355,
    ...
    hours: "Museums Tue–Sun 09:30–17:30 (closed Mondays)",
    ticketPrice: "Combined 6-museum ticket 6 BGN · Single museum 3 BGN",
    bestTime: "May–October — winters are cold and many museums shorten hours",
  ...
  {
    slug: "bachkovo-monastery",
    name: "Bachkovo Monastery",
    city: "Rhodope Mountains",
    description: "Second-largest monastery, founded in 1083.",
    emoji: "🛕",
    lat: 41.9408,
    lng: 24.8503,
    ...
    ticketPrice: "Free · Donations welcome · Ossuary 2 BGN",
    bestTime: "Weekdays — weekends bring large pilgrim groups",
  ...
  {
    slug: "shipka-memorial",
    name: "Shipka Memorial",
    city: "Shipka Pass",
    description: "Liberation-war monument crowning the Balkan range.",
    emoji: "🗿",
    lat: 42.7553,
    lng: 25.3206,
    ...
    hours: "Apr–Oct 09:00–17:30 · Nov–Mar 09:00–16:00",
    ticketPrice: "Adults 5 BGN · Students 2 BGN",
    bestTime: "Clear summer days for the 360° Balkan views",
  ...
  {
    slug: "devils-throat-cave",
    name: "Devil's Throat Cave",
    city: "Trigrad Gorge",
    description: "Roaring underground waterfall in the Rhodopes.",
    emoji: "🕳️",
    lat: 41.6158,
    lng: 24.3736,
    ...
    hours: "Apr–Oct 09:00–17:00 · winter by appointment",
    ticketPrice: "Adults 6 BGN · Children 3 BGN",
    bestTime: "May & June when the waterfall is at peak flow",
  ...
  },
  {
    ...
    name: "Pobiti Kamani",
    city: "near Varna",
    description: "Eerie stone desert of natural rock columns.",
    emoji: "🏜️",
    lat: 43.2236,
    lng: 27.7053,
    ...
    hours: "Daily 08:00–20:00 (gates close earlier off-season)",
    ticketPrice: "Adults 3 BGN · Children 1 BGN",
    bestTime: "Spring & autumn — summer midday is harsh and shadeless",
  ...
  {
    slug: "sveti-vlas-marina",
    name: "Sveti Vlas Marina",
    city: "Sveti Vlas",
    description: "Yacht harbor under the Stara Planina foothills.",
    emoji: "⚓",
    lat: 42.7106,
    lng: 27.7575,
    ...
    hours: "Open 24/7 · Restaurants 10:00–23:00",
    ticketPrice: "Free to walk · Boat trips from 25 BGN",
    bestTime: "Sunset in summer for the harbour light show",
  ...
  },
  {
    ...
    city: "Asenovgrad",
    description: "Cliffside medieval fort with a lone red church.",
    emoji: "🏯",
    lat: 41.9911,
    lng: 24.8744,
    ...
    hours: "Apr–Oct 09:00–18:00 · Nov–Mar 10:00–16:00",
    ticketPrice: "Adults 4 BGN · Students 2 BGN",
    bestTime: "Late afternoon when the rocks turn gold",
  ...
  },
  {
    ...
    name: "Krushuna Falls",
    city: "near Lovech",
    description: "Travertine cascades through emerald pools.",
    emoji: "💧",
    lat: 43.2336,
    lng: 25.015,
    ...
    ticketPrice: "Park entry 3 BGN",
    bestTime: "Spring after snowmelt for maximum flow",
...
const $$splitComponentImporter = () => import("./landmark._slug-BrpZUIV3.js");
const $$splitNotFoundComponentImporter = () => import("./landmark._slug-BkHp-_Wp.js");
const Route2 = createFileRoute("/landmark/$slug")({
  loader: ({
    params
  }) => {
...
const LandmarkSlugRoute = Route2.update({
  id: "/landmark/$slug",
  path: "/landmark/$slug",
  getParentRoute: () => Route$3
});
