...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Im_Asjum.js");
...
const manifest = {
  "28e7c8b0f2727de9cffe105454951f9ac3681aa2861880040e8358d917710611": {
    functionName: "getBdzSchedule_createServerFn_handler",
    importer: () => import("./bdz.functions-Bo3uSpV6.js")
  },
  "3591a48adbedeb2e372e722c18c01a688c5d5e6ff055973c69e511d347b04fd3": {
    functionName: "getDirections_createServerFn_handler",
    importer: () => import("./directions.functions-DrKV9jVV.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BFR-v_9l.js").then((n2) => n2.w),
    import("./start-CHi88XUr.js"),
